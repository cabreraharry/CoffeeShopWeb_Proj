...
<div class="container m.php
    <div class="row">
        <div class="col-lg-8 col-md-10 text-white">
            <h1 class="mb-4">About Us</h1>
            <p>We are passionate about coffee and dedicated to providing our customers with the best coffee experience possible. Our beans are sourced from the finest coffee-growing regions, and our expert baristas ensure that every cup is brewed to perfection.</p>
        </div>
    </div>
</div>
